              ...
              {filteredPatients.map(patient => (
                <tr key={patient.id} className="hover:bg-slate-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right">
                    <button onClick={() => navigate(`/doctor/patients/${patient.id}`)} className="text-teal-600 hover:text-teal-900 p-2 hover:bg-teal-50 rounded"><Eye className="w-4 h-4" /></button>
                  </td>
                </tr>
              ))}
            </tbody>
